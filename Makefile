...
ACLOCAL = ${SHELL} /f/BTCDeps/mirrorcpu/missing --run aclocal-1.11
ALLOCA = 
AMTAR = ${SHELL} /f/BTCDeps/mirrorcpu/missing --run tar
AUTOCONF = ${SHELL} /f/BTCDeps/mirrorcpu/missing --run autoconf
AUTOHEADER = ${SHELL} /f/BTCDeps/mirrorcpu/missing --run autoheader
AUTOMAKE = ${SHELL} /f/BTCDeps/mirrorcpu/missing --run automake-1.11
AWK = gawk
CC = x86_64-w64-mingw32-gcc -std=gnu99
CCAS = x86_64-w64-mingw32-gcc -std=gnu99
CCASDEPMODE = depmode=gcc3
CCASFLAGS = -O3 -DCPU_X86_FORCE_INTRINSICS
CCDEPMODE = depmode=gcc3
CFLAGS = -O3 -DCPU_X86_FORCE_INTRINSICS
CPP = x86_64-w64-mingw32-gcc -std=gnu99 -E
CPPFLAGS = 
CYGPATH_W = echo
DEFS = -DHAVE_CONFIG_H
DEPDIR = .deps
...
LDFLAGS = 
LIBCURL = -L/f/BTCDeps/MinGW64/lib -lcurl -lwldap32 -lws2_32
LIBCURL_CPPFLAGS = -I/f/BTCDeps/MinGW64/include
LIBOBJS = 
LIBS = 
LTLIBOBJS = 
MAINT = #
MAKEINFO = ${SHELL} /f/BTCDeps/mirrorcpu/missing --run makeinfo
MKDIR_P = /bin/mkdir -p
OBJEXT = o
PACKAGE = cpuminer
PACKAGE_BUGREPORT = 
...
WS2_LIBS = -lws2_32
_libcurl_config = 
abs_builddir = /f/BTCDeps/mirrorcpu
abs_srcdir = /f/BTCDeps/mirrorcpu
abs_top_builddir = /f/BTCDeps/mirrorcpu
abs_top_srcdir = /f/BTCDeps/mirrorcpu
ac_ct_CC = 
am__include = include
am__leading_dot = .
am__quote = 
...
install_sh = ${SHELL} /f/BTCDeps/mirrorcpu/install-sh
...
minerd_LDADD = -L/f/BTCDeps/MinGW64/lib -lcurl -lwldap32 -lws2_32 compat/jansson/libjansson.a -lpthread -lws2_32
minerd_CPPFLAGS = -I/f/BTCDeps/MinGW64/include
...
minerd-sha256.o: sha256.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-sha256.o -MD -MP -MF $(DEPDIR)/minerd-sha256.Tpo -c -o minerd-sha256.o `test -f 'sha256.c' || echo '$(srcdir)/'`sha256.c
	$(am__mv) $(DEPDIR)/minerd-sha256.Tpo $(DEPDIR)/minerd-sha256.Po
#	source='sha256.c' object='minerd-sha256.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-sha256.o `test -f 'sha256.c' || echo '$(srcdir)/'`sha256.c

minerd-sha256.obj: sha256.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-sha256.obj -MD -MP -MF $(DEPDIR)/minerd-sha256.Tpo -c -o minerd-sha256.obj `if test -f 'sha256.c'; then $(CYGPATH_W) 'sha256.c'; else $(CYGPATH_W) '$(srcdir)/sha256.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-sha256.Tpo $(DEPDIR)/minerd-sha256.Po
#	source='sha256.c' object='minerd-sha256.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-sha256.obj `if test -f 'sha256.c'; then $(CYGPATH_W) 'sha256.c'; else $(CYGPATH_W) '$(srcdir)/sha256.c'; fi`

minerd-radiogatun.o: radiogatun.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-radiogatun.o -MD -MP -MF $(DEPDIR)/minerd-radiogatun.Tpo -c -o minerd-radiogatun.o `test -f 'radiogatun.c' || echo '$(srcdir)/'`radiogatun.c
	$(am__mv) $(DEPDIR)/minerd-radiogatun.Tpo $(DEPDIR)/minerd-radiogatun.Po
#	source='radiogatun.c' object='minerd-radiogatun.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-radiogatun.o `test -f 'radiogatun.c' || echo '$(srcdir)/'`radiogatun.c

minerd-radiogatun.obj: radiogatun.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-radiogatun.obj -MD -MP -MF $(DEPDIR)/minerd-radiogatun.Tpo -c -o minerd-radiogatun.obj `if test -f 'radiogatun.c'; then $(CYGPATH_W) 'radiogatun.c'; else $(CYGPATH_W) '$(srcdir)/radiogatun.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-radiogatun.Tpo $(DEPDIR)/minerd-radiogatun.Po
#	source='radiogatun.c' object='minerd-radiogatun.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-radiogatun.obj `if test -f 'radiogatun.c'; then $(CYGPATH_W) 'radiogatun.c'; else $(CYGPATH_W) '$(srcdir)/radiogatun.c'; fi`

minerd-panama.o: panama.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-panama.o -MD -MP -MF $(DEPDIR)/minerd-panama.Tpo -c -o minerd-panama.o `test -f 'panama.c' || echo '$(srcdir)/'`panama.c
	$(am__mv) $(DEPDIR)/minerd-panama.Tpo $(DEPDIR)/minerd-panama.Po
#	source='panama.c' object='minerd-panama.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-panama.o `test -f 'panama.c' || echo '$(srcdir)/'`panama.c

minerd-panama.obj: panama.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-panama.obj -MD -MP -MF $(DEPDIR)/minerd-panama.Tpo -c -o minerd-panama.obj `if test -f 'panama.c'; then $(CYGPATH_W) 'panama.c'; else $(CYGPATH_W) '$(srcdir)/panama.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-panama.Tpo $(DEPDIR)/minerd-panama.Po
#	source='panama.c' object='minerd-panama.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-panama.obj `if test -f 'panama.c'; then $(CYGPATH_W) 'panama.c'; else $(CYGPATH_W) '$(srcdir)/panama.c'; fi`

minerd-mirror.o: mirror.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-mirror.o -MD -MP -MF $(DEPDIR)/minerd-mirror.Tpo -c -o minerd-mirror.o `test -f 'mirror.c' || echo '$(srcdir)/'`mirror.c
	$(am__mv) $(DEPDIR)/minerd-mirror.Tpo $(DEPDIR)/minerd-mirror.Po
#	source='mirror.c' object='minerd-mirror.o' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-mirror.o `test -f 'mirror.c' || echo '$(srcdir)/'`mirror.c

minerd-mirror.obj: mirror.c
	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -MT minerd-mirror.obj -MD -MP -MF $(DEPDIR)/minerd-mirror.Tpo -c -o minerd-mirror.obj `if test -f 'mirror.c'; then $(CYGPATH_W) 'mirror.c'; else $(CYGPATH_W) '$(srcdir)/mirror.c'; fi`
	$(am__mv) $(DEPDIR)/minerd-mirror.Tpo $(DEPDIR)/minerd-mirror.Po
#	source='mirror.c' object='minerd-mirror.obj' libtool=no \
#	DEPDIR=$(DEPDIR) $(CCDEPMODE) $(depcomp) \
#	$(CC) $(DEFS) $(DEFAULT_INCLUDES) $(INCLUDES) $(minerd_CPPFLAGS) $(CPPFLAGS) $(AM_CFLAGS) $(CFLAGS) -c -o minerd-mirror.obj `if test -f 'mirror.c'; then $(CYGPATH_W) 'mirror.c'; else $(CYGPATH_W) '$(srcdir)/mirror.c'; fi`
